...
import ContentHos from "./HospText";

export default function HospCon() {
  return (
    <>
    <Navbar/>
    <div className="bg-white min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 px-8 py-8">
        ...
        <div className="text-blue-700 text-sm mb-2">
          Katherine L. Gudiksen; Andréa E. Caballero; Paul B. Ginsburg; Bruce Allain; Thomas L. Greaney; Brent D. Fulton
        </div>
        <div className="text-gray-700 text-sm mb-2">
          J Health Polit Policy Law (2025) 50 (5): 681–708.
        </div>
        <a
          href="https://doi.org/10.1215/03616878-11853756"
          className="text-blue-700 text-sm underline mb-4 block"
          target="_blank"
          rel="noopener noreferrer"
        >
          https://doi.org/10.1215/03616878-11853756
        </a>
        ...
        <div className="flex gap-2 mb-6">
          ...
          <a className="flex items-center gap-1 px-3 py-2 bg-gray-50 border rounded text-sm font-medium hover:bg-gray-100 cursor-pointer" onClick={() => window.open("/pdf/hos.pdf", "_blank", "noopener,noreferrer")}>
            {/* Icon: PDF */}
