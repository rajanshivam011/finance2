      ...
      <div className="bg-white min-h-screen flex flex-col md:flex-row">
        ...
        <div className="flex-1 px-8 py-8">
          <div className="text-xs text-gray-500 font-semibold mb-2 tracking-wide">
            RESEARCH ARTICLE | OCTOBER 01 2025
          </div>
          ...
          <span className="inline-block bg-green-100 text-green-700 text-xs font-bold rounded px-2 py-0.5 mb-2">
            FREE
          </span>
          <div className="text-blue-700 text-sm mb-2">
            <a href="#" className="hover:underline">Rachael L. M. Erickson</a>;{" "}
            <a href="#" className="hover:underline">Joshua Meyer-Gutbrod</a>
          </div>
          <div className="text-gray-700 text-sm mb-2">
            J Health Polit Policy Law (2025) 50 (5): 709–734.
          </div>
          <a
            href="https://doi.org/10.1215/03616878-11853740"
            className="text-blue-700 text-sm underline mb-4 block"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://doi.org/10.1215/03616878-11853740
          </a>
          ...
          <div className="flex gap-2 mb-6">
            ...
            <a className="flex items-center gap-1 px-3 py-2 bg-gray-50 border rounded text-sm font-medium hover:bg-gray-100 cursor-pointer" href="/pdf/2.pdf" target="_blank" rel="noopener noreferrer">
              {/* Icon: PDF */}
          ...
          <div className="bg-gray-50 border rounded p-6 mt-4">
            <div className="text-xl font-bold mb-2">Abstract</div>
