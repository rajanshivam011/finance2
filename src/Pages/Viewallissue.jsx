  ...
  issue1: [
    {
      ...
      articles: [
        ...
        // ... (other articles from the original data)
      ],
    },
    {
      ...
      articles: [
        {
          ...
          url: "/issue2/1.pdf",
          authors: ["1 Aji Suprayogo, 2Irni Yunita "],
          free: true,
          abstract: `Operational efficiency is a major challenge for PT PLN (Persero) in ensuring resource optimization amidst the
        ...
        },
        {
          ...
          free: true,
          abstract: `-Chester disease (ECD) is a rare, multisystemic non-Langerhans cell histiocytosis that causes
          clonal proliferation of lipid-laden CD68⁺/CD1a⁻ foamy histiocytes.`,
          links: [
            { label: "Abstract" },
     ...
     
        {
          ...
          free: true,
          abstract: `Nepal’s National Pride Projects (NPPs) face persistent delays and cost overruns, yet limited evidence exists
          on howmanagerial, technical, financial, and institutional determinants collectively shape outcomes. `,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `Providing clean water is essential for public health and well-being. In Indonesia, Perusahaan Daerah Air Minum
          (PDAM), or regional water supply companies, play a crucial role in delivering this essential service.`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `This study aims to evaluate the implementation of birth certificate services in Makassar City through the lens
          of William N. Dunn’s six policy evaluation criteria: effectiveness, efficiency, adequacy, equity, responsiveness, and
          accuracy. `,
          links: [
            { label: "Abstract" },
      ...
      articles: [
        {
          ...
          free: true,
          abstract: `: This study presents a comprehensive evaluation of Static Random-Access Memory (SRAM) cells focusing
          on the design and validation of architectures ranging from six-transistor (6T) to ten-transistor (10T) configurations. `,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          url: "/issue3/2.pdf",
          authors: ["Ari Kuncara Widagdo¹, Rahmawati ², Siti Rochmah Ika 3, Ratna Wijayanti Daniar Paramita 4, SriHartoko 5, Lyna Latifah ⁶"],
          free: true,
          abstract: `The objective of this study is to examine the impact of green entrepreneurship and innovation
              on the enhancement of green business performance in micro, small, and medium-sized enterprises
              (MSMEs), with a particular focus on the tourism sector in Indonesia`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          url: "/issue3/3.pdf",
          authors: ["Bapanapalli Madhu Babu1, Dr. A.Raja 2 and Dr. B. Durga Prasad3"],
          free: true,
          abstract: `This study examines the effects of potassium alum, in crystalline (PAC) and powdered (PAP) forms, on
          diesel engine performance, combustion, and emissions. Diesel was blended with 50g, 100g, and 150g of PAC and
          PAP, held for 72 hours`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `Divergent thinking is a type of creative thinking that can provide various possible answers based on the
        ...
        },
        {
          ...
          free: true,
          abstract: `This study investigates the integrative effects of Contra Marketing (CM) and Viral Marketing (VM) on Online
          Decision-Making (ODM) among Generation Z in South Kalimantan, Indonesia representing a tier-2 digital ecosystem
          within ASEAN’s emerging markets`,
          links: [
            { label: "Abstract" },
      ...
      articles: [
        {
          ...
          free: true,
          abstract: `The main objective of this research was to analyze the impact of capital structure and cost of capital
          on the profitability and economic sustainability of small and medium-sized enterprises (SMEs) in Peru, using
          Trade-Off Theory as a theoretical framework`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `- Overindulgence in mobile device usage is a prevalent lifestyle habit among young people and
        ...
        },
        {
          ...
          free: true,
          abstract: `This study investigates the established relationship between emotional intelligence (EI) and employee creativity (EC)
          through a comprehensive reviews and Bibliometric Analysis of 413 research articles sourced from the SCOPUS
          database`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `Since Section 135 of the Companies Act (2013) requires CSR investment in rising economies like India, corporate social
          responsibility (CSR) has changed from a charitable option to a strategic imperative.`,
          links: [
            { label: "Abstract" },
      ...
      articles: [
        {
          ...
          free: true,
          abstract: `Essential oil is volatile organic liquid compound extracted from different plant parts of various plant materials.
          Essential oil has been used in many industries like pharmaceuticals, perfumery, cosmetics, and food industries due to
          their natural properties like antifungal, anti-aging, antiseptic and many other activities`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `Button mushroom farming is a complex agricultural practice requiring precise control and monitoring
          of various environmental variables to ensure optimal growth conditions and maximize yield`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          url: "/issue5/4.pdf",
          authors: ["Femy Francis1* and Dr Chinnasamy K2"],
          free: true,
          abstract: `In this digital era, electronic resources (e-resources) are becoming an essential part of education and research. As the use of
          eresources continues to grow, it is necessary to understand the trends and patterns in the literature surrounding them.`,
          links: [
            { label: "Abstract" },
        ...
        },
        {
          ...
          free: true,
          abstract: `The search for sustainable transformer insulating fluids has led to increased interest in biodegradable vegetable oils as
...
export default function Viewallissue() {
  ...
  useEffect(() => {
    // Simulate fetching data for the selected issue
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <main className="flex-1">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <button
                className="cursor-pointer mb-4 px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-all absolute"
              ...
              {showPopup && (
                <div className="cursor-pointer fixed inset-0 bg-opacity-50 flex items-center justify-center z-20">
                  <div className="bg-white rounded-lg p-6 w-80">
                    ...
                    {["issue1", "issue2", "issue3", "issue4", "issue5"].map((issue) => (
                      <button
                        key={issue}
                        className={`w-full text-left px-4 py-2 mb-2 rounded-lg ${
                          selectedIssue === issue ? "bg-teal-100 text-teal-700" : "bg-teal-50 text-teal-600"
